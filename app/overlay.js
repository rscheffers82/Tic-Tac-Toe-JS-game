$('.overlaybox').on('click', '.pl', function(){
      ...
      '<p>Player: <i class="note">(optional)</i> <input type="text" id="player1"></p>' +
        ...
        '<p>Difficulty: ' +
            '<select id="difficulty">' +
                '<option value="100">UNBEATABLE:        It is your destiny to lose</option>' +
...
var showScore = function(player, draw, message){    //eslint-disable-line
  $('.overlaybox').empty();
